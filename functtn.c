...
/**
 * char_count - calculates chars occurrences
 * @str: string to check
 * @idx: value of idx
 * Return: calculate
 */
...
/**
 * sytx_err_check - locate and output error
...
/**
 * find_sytx_err - evaluate for syntax errors
...
/**
 * find_first_idx - evaluate for idx of first occurrence of a char
 * @str: string to evaluate
 * @idx: value of idx
...
/**
 * sytx_err_print - outputs syntax error message
 * @cli_frame: data
 * @str: string to evaluate
 * @idx: error index
