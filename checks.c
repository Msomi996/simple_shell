...
/**
 * str_to_var - switches str with variables
 * @hd: linked list head
 * @f_len: complete length
 * @str: str input
 * @str_new: strng to replace
 * Return: strng switch
 */
...
/**
 * str_var_func - request correct function to replace str
 * @str: str input
 * @cli_frame: data
